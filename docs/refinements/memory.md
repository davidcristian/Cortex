...
- **A session delete tells the seam an undecodable reply is an outage, opened 2026-08-11 by the
  data-defect close ([ADR-0008](../adr/ADR-0008-memory-v1.md)).** *Fix when it bites.* The close
