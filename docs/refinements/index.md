...
**120 open, 296 closed, 416 in total.**
...
- **[R-415](tasks/415-the-swap-path-names-its-work-with-bare-nouns.md)** The swap path names its work with bare nouns while the rest of the brain suffixes them (cross-cutting).
...
- [R-415](tasks/415-the-swap-path-names-its-work-with-bare-nouns.md) The swap path names its work with bare nouns while the rest of the brain suffixes them. open, actionable.
