...
**170 open, 405 closed, 575 in total.**
...
- **[R-568](tasks/568-a-report-of-the-rule-without-its-quote-marks-reads-as-applied.md)** A report of the rule that sheds the payload's quote marks reads as the rule applied (vision).
...
- [R-568](tasks/568-a-report-of-the-rule-without-its-quote-marks-reads-as-applied.md) A report of the rule that sheds the payload's quote marks reads as the rule applied. open, actionable.
