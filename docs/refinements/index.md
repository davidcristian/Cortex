...
**174 open, 440 closed, 614 in total.**
...
- **[R-614](tasks/614-a-refused-spawn-reaches-no-log-line.md)** A refused spawn reaches no log line (resource-governance).
...
- [R-614](tasks/614-a-refused-spawn-reaches-no-log-line.md) A refused spawn reaches no log line. open, actionable.
