...
**166 open, 469 closed, 635 in total.**
...
113 of these record the day their claims were last re-derived from the code. On every other task here, that reading is still yours to take.
...
- **[R-633](tasks/633-the-paired-arm-identity-is-counted-by-a-scratch-script.md)** The paired-arm identity is counted by a scratch script rather than a gated reader (inference).
- **[R-634](tasks/634-the-body-handed-back-passes-both-rates.md)** The body handed back passes both rates (subagents).
- **[R-635](tasks/635-the-lookup-judge-passes-an-invented-instance-beside-the-bodys-phrase.md)** The lookup judge passes an invented instance beside the body's phrase (subagents).
...
- **[R-218](tasks/218-tunnel-fallback.md)** Q3 body-initiated-stream tunnel fallback (body-gateway). Reopens when: `host.docker.internal` failing, from a bridge-network container on this host, to reach a host service bound to an interface a container can see. Its claim was re-derived from the code on 2026-09-11.
...
- **[R-441](tasks/441-a-token-in-dotenv-reaches-compose-and-not-just.md)** A seam token written in .env reaches compose and never reaches just (seam-auth). Reopens when: an operator keeps the seam token in `.env` rather than in the environment, since that is the first moment the two readers of that file disagree about what is configured. Its claim was re-derived from the code on 2026-09-11.
...
- [R-633](tasks/633-the-paired-arm-identity-is-counted-by-a-scratch-script.md) The paired-arm identity is counted by a scratch script rather than a gated reader. open, actionable.
...
- [R-634](tasks/634-the-body-handed-back-passes-both-rates.md) The body handed back passes both rates. open, actionable.
- [R-635](tasks/635-the-lookup-judge-passes-an-invented-instance-beside-the-bodys-phrase.md) The lookup judge passes an invented instance beside the body's phrase. open, actionable.
