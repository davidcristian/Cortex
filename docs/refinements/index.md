...
**164 open, 395 closed, 559 in total.**
...
- **[R-547](tasks/547-the-pairs-budget-half-has-no-injection-row-of-its-own.md)** The pair's budget half has no injection row of its own (inference).
...
- [R-547](tasks/547-the-pairs-budget-half-has-no-injection-row-of-its-own.md) The pair's budget half has no injection row of its own. open, actionable.
