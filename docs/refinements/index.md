...
**133 open, 330 closed, 463 in total.**
...
- **[R-458](tasks/458-the-ports-thinking-switch-is-conditional.md)** The port's thinking switch holds on one request shape and silently does nothing on another (inference).
...
- **[R-463](tasks/463-the-subagent-couplings-part-is-two-lines-under-the-cap.md)** The subagent couplings part sits two lines under the line cap (repo-gates). Reopens when: the next coupling written into `scripts/subagentcouplings.py`, which will not fit.
...
- [R-458](tasks/458-the-ports-thinking-switch-is-conditional.md) The port's thinking switch holds on one request shape and silently does nothing on another. open, actionable.
...
- [R-463](tasks/463-the-subagent-couplings-part-is-two-lines-under-the-cap.md) The subagent couplings part sits two lines under the line cap. open, fix when it bites.
