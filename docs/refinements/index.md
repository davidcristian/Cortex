...
**89 open, 218 closed, 307 in total.**
...
- **[R-305](tasks/305-optional-toolchain-relays.md)** Deleting a toolchain relay deletes its check, silently (repo-gates).
- **[R-306](tasks/306-subagent-memory-budget-spelled-twice.md)** A subagent budget's default is spelled twice in one compose file and tied nowhere (repo-gates).
...
- [R-305](tasks/305-optional-toolchain-relays.md) Deleting a toolchain relay deletes its check, silently. open, actionable.
- [R-306](tasks/306-subagent-memory-budget-spelled-twice.md) A subagent budget's default is spelled twice in one compose file and tied nowhere. open, actionable.
