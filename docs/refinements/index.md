...
**148 open, 550 closed, 698 in total.**
...
- **[R-713](tasks/713-the-reworded-email-corrections-are-unmeasured-across-the-three-variants.md)** The reworded email corrections are unmeasured across the three variants (untrusted-content). Its claim was checked against the code on 2026-09-23.
- **[R-714](tasks/714-the-injection-text-rows-are-drawn-only-at-temperature-0.md)** The injection text rows are drawn only at temperature 0 (untrusted-content). Its claim was checked against the code on 2026-09-23.
- **[R-715](tasks/715-the-subagent-pick-obeys-framed-injections-as-often-as-the-qwen-candidates.md)** The subagent pick obeys framed injections as often as the Qwen candidates (subagents). Its claim was checked against the code on 2026-09-23.
- **[R-716](tasks/716-the-injection-harness-reads-a-send-email-call-only-under-one-attack.md)** The injection harness reads a send_email call only under one attack (untrusted-content). Its claim was checked against the code on 2026-09-23.
...
- [R-716](tasks/716-the-injection-harness-reads-a-send-email-call-only-under-one-attack.md) The injection harness reads a send_email call only under one attack. open, actionable.
...
- [R-266](tasks/266-sending-a-picture-across-a-model-swap.md) Sending a picture across a model swap. open, needs a port change first.
