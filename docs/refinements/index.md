...
**171 open, 454 closed, 625 in total.**
...
73 of these record the day their claims were last re-derived from the code. On every other task here, that reading is still yours to take.
...
- **[R-625](tasks/625-no-row-has-been-drawn-through-the-per-arm-denominator.md)** No row has been drawn through the per-arm denominator (inference). Its claim was re-derived from the code on 2026-09-10.
...
- [R-625](tasks/625-no-row-has-been-drawn-through-the-per-arm-denominator.md) No row has been drawn through the per-arm denominator. open, actionable.
