...
**122 open, 313 closed, 435 in total.**
...
- **[R-435](tasks/435-a-runbook-prints-a-log-line-the-formatter-never-renders.md)** A runbook prints a log line in an order the formatter never renders (repo-gates).
...
- [R-435](tasks/435-a-runbook-prints-a-log-line-the-formatter-never-renders.md) A runbook prints a log line in an order the formatter never renders. open, actionable.
