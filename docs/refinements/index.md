...
**121 open, 303 closed, 424 in total.**
...
- **[R-424](tasks/424-every-probe-run-leaves-an-anonymous-volume.md)** Every probe run leaves an anonymous volume behind, against its own promise (email-confirmer).
...
- [R-424](tasks/424-every-probe-run-leaves-an-anonymous-volume.md) Every probe run leaves an anonymous volume behind, against its own promise. open, actionable.
