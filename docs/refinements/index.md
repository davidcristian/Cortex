...
**111 open, 256 closed, 367 in total.**
...
- **[R-363](tasks/363-the-call-bound-and-the-run-bound-are-unordered.md)** A tool call may be bounded above the run that has to contain it (tools-mcp).
...
- [R-363](tasks/363-the-call-bound-and-the-run-bound-are-unordered.md) A tool call may be bounded above the run that has to contain it. open, actionable.
