...
**167 open, 397 closed, 564 in total.**
...
- **[R-544](tasks/544-share-and-glyph-pixels-are-one-variable-at-one-frame.md)** The payload's share and the pixels per glyph are one variable at one frame (vision).
- **[R-545](tasks/545-the-plain-renderings-legibility-floor-is-not-bracketed.md)** The plain rendering never went illegible, so the crossing is unbracketed where it matters most (vision).
...
- **[R-564](tasks/564-three-published-pixel-matrices-are-re-read-from-a-hand-sort.md)** Three published pixel matrices and every rate column are re-read from a hand sort (vision).
...
- [R-542](tasks/542-the-shipped-budgets-rate-row-has-one-sitting.md) The shipped budget's rate row has one sitting and the budget it is compared against has two. open, actionable.
...
- [R-544](tasks/544-share-and-glyph-pixels-are-one-variable-at-one-frame.md) The payload's share and the pixels per glyph are one variable at one frame. open, actionable.
- [R-545](tasks/545-the-plain-renderings-legibility-floor-is-not-bracketed.md) The plain rendering never went illegible, so the crossing is unbracketed where it matters most. open, actionable.
...
- [R-564](tasks/564-three-published-pixel-matrices-are-re-read-from-a-hand-sort.md) Three published pixel matrices and every rate column are re-read from a hand sort. open, actionable.
