...
**97 open, 186 closed, 283 in total.**

## What remains

8 of these wait on something nobody wrote down. That is a gap in the record rather than a decision, and reading one of them closes it.

### Actionable, once a seam or port changes (4)
...
- **[R-283](tasks/283-a-chosen-homoglyph-outlives-any-table.md)** A chosen homoglyph outlives any table (untrusted-content).
...
- **[R-059](tasks/059-mixed-other-encodings.md)** Mixed and other encodings past percent and HTML (untrusted-content). No trigger was ever recorded for it.
...
- [R-059](tasks/059-mixed-other-encodings.md) Mixed and other encodings past percent and HTML. open, fix when it bites.
...
- [R-283](tasks/283-a-chosen-homoglyph-outlives-any-table.md) A chosen homoglyph outlives any table. open, a seam or port change comes first.
