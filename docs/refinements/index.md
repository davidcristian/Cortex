...
**155 open, 525 closed, 680 in total.**
...
- **[R-684](tasks/684-a-secret-named-argument-prints-on-both-audit-trails.md)** A secret-named argument prints its value on both audit trails (tools-mcp). Its claim was re-derived from the code on 2026-09-17.
...
- [R-684](tasks/684-a-secret-named-argument-prints-on-both-audit-trails.md) A secret-named argument prints its value on both audit trails. open, actionable.
