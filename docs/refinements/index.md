...
**150 open, 562 closed, 712 in total.**
...
- **[R-735](tasks/735-flash-nexts-feasibility-row-is-not-complete-at-the-shipped-memory-cap.md)** Flash-Next's feasibility row is not complete at the shipped memory cap (inference). Its claim was checked against the code on 2026-09-26.
- **[R-736](tasks/736-the-deep-phase-sends-a-history-window-sized-for-the-cortexs-context.md)** The deep phase sends a history window sized for the cortex's context (session-history). Its claim was checked against the code on 2026-09-26.
- **[R-740](tasks/740-the-recall-judge-and-the-recap-are-unmeasured-on-the-qwen-deep-candidates.md)** The recall judge and the recap are unmeasured on the Qwen deep candidates (memory). Its claim was checked against the code on 2026-09-26.
- **[R-742](tasks/742-the-mixture-of-experts-rejection-rests-on-unrecorded-questions.md)** The mixture-of-experts rejection rests on unrecorded questions (inference). Its claim was checked against the code on 2026-09-26.
- **[R-743](tasks/743-the-session-and-handoff-codecs-decode-a-system-role-no-writer-stores.md)** The session and handoff codecs decode a system role no writer stores (session-history). Its claim was checked against the code on 2026-09-26.
- **[R-744](tasks/744-the-joined-system-message-is-unmeasured-on-the-qwen-alternates.md)** The joined system message is unmeasured on the Qwen alternates (untrusted-content). Its claim was checked against the code on 2026-09-26.
...
- **[R-738](tasks/738-the-deep-tier-cannot-set-a-templates-reasoning-effort-or-preserve-flag.md)** The deep tier cannot set a template's reasoning effort or preserve flag (inference-model-manager). Reopens when: ADR-0004 names a Qwen3.8 artifact as a pick or alternate for any tier, or the maintainer picks the step two names below. Its claim was checked against the code on 2026-09-26.
- **[R-739](tasks/739-the-deep-tier-cannot-name-a-drafter-built-into-its-own-model.md)** The deep tier cannot name a drafter built into its own model (inference-model-manager). Reopens when: a Qwen3.8 artifact named in `CORTEX_MODEL_FILE_BRAIN` by a compose default, a recipe or an env file in this tree, or ADR-0004 decision 8 naming Qwen3.8-27B as the deep pick or its alternate. Read it with `grep -rn 'CORTEX_MODEL_FILE_BRAIN' docker/ justfile` and decision 8's first sentence. Its claim was checked against the code on 2026-09-26.
- **[R-741](tasks/741-a-qwen38-27b-deep-tier-has-no-measured-fit-figure-or-decode-floor.md)** A Qwen3.8-27B deep tier has no measured fit figure or decode floor (resource-governance). Reopens when: a Qwen3.8 artifact named in `CORTEX_MODEL_FILE_BRAIN` by a compose default, a recipe or an env file in this tree, or ADR-0004 decision 8 naming Qwen3.8-27B as the deep pick or its alternate. Read it with `grep -rn 'CORTEX_MODEL_FILE_BRAIN' docker/ justfile` and decision 8's first sentence. Its claim was checked against the code on 2026-09-26.
- **[R-745](tasks/745-device-control-reaches-only-the-system-volume.md)** Device control reaches only the system volume (body-gateway). Reopens when: The maintainer picks a route below, or names the native actions a first slice builds. Its claim was checked against the code on 2026-09-26.
...
- [R-157](tasks/157-liquid-edge-backdrop-blur.md) The liquid edge's backdrop blur. done 2026-09-25.
...
- [R-607](tasks/607-eighteen-of-the-cortex-alts-pixel-rows-are-undrawn.md) Eight of the cortex alt's thirty-six pixel rows are undrawn. open, actionable.
...
- [R-735](tasks/735-flash-nexts-feasibility-row-is-not-complete-at-the-shipped-memory-cap.md) Flash-Next's feasibility row is not complete at the shipped memory cap. open, actionable.
- [R-742](tasks/742-the-mixture-of-experts-rejection-rests-on-unrecorded-questions.md) The mixture-of-experts rejection rests on unrecorded questions. open, actionable.
...
- [R-738](tasks/738-the-deep-tier-cannot-set-a-templates-reasoning-effort-or-preserve-flag.md) The deep tier cannot set a template's reasoning effort or preserve flag. open, waiting for its trigger.
- [R-739](tasks/739-the-deep-tier-cannot-name-a-drafter-built-into-its-own-model.md) The deep tier cannot name a drafter built into its own model. open, waiting for its trigger.
...
- [R-740](tasks/740-the-recall-judge-and-the-recap-are-unmeasured-on-the-qwen-deep-candidates.md) The recall judge and the recap are unmeasured on the Qwen deep candidates. open, actionable.
...
- [R-741](tasks/741-a-qwen38-27b-deep-tier-has-no-measured-fit-figure-or-decode-floor.md) A Qwen3.8-27B deep tier has no measured fit figure or decode floor. open, waiting for its trigger.
...
- [R-736](tasks/736-the-deep-phase-sends-a-history-window-sized-for-the-cortexs-context.md) The deep phase sends a history window sized for the cortex's context. open, actionable.
- [R-743](tasks/743-the-session-and-handoff-codecs-decode-a-system-role-no-writer-stores.md) The session and handoff codecs decode a system role no writer stores. open, actionable.
...
- [R-744](tasks/744-the-joined-system-message-is-unmeasured-on-the-qwen-alternates.md) The joined system message is unmeasured on the Qwen alternates. open, actionable.
