...
**142 open, 352 closed, 494 in total.**
...
- **[R-474](tasks/474-the-switch-could-be-rendered-as-a-lever-that-holds.md)** The port's thinking switch could be rendered as a lever that holds (inference).
...
- **[R-295](tasks/295-per-request-trace-budget.md)** One tier still has one thinking budget (inference-model-manager). Reopens when: a llama.cpp build that reads a thinking budget off the request body, or a second caller on one tier whose right budget is a different positive count from the first's.
...
- [R-474](tasks/474-the-switch-could-be-rendered-as-a-lever-that-holds.md) The port's thinking switch could be rendered as a lever that holds. open, actionable.
...
- [R-295](tasks/295-per-request-trace-budget.md) One tier still has one thinking budget. open, fix when it bites.
