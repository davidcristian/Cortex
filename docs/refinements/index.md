...
**114 open, 276 closed, 390 in total.**
...
- **[R-385](tasks/385-a-note-beside-a-compose-value-is-read-as-a-spend.md)** A note written after a compose value is read as a spend of the variable it names (repo-gates).
...
- [R-385](tasks/385-a-note-beside-a-compose-value-is-read-as-a-spend.md) A note written after a compose value is read as a spend of the variable it names. open, actionable.
