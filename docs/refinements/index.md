...
**161 open, 499 closed, 660 in total.**
...
- **[R-340](tasks/340-the-deep-phase-cannot-see-a-cut-call.md)** The deep phase reads a cut tool call as a dead server (inference-model-manager). Reopens when: the first handoff observed settling FAILED whose partial answer ends mid tool call, or a third `except MalformedToolCallError` arm appearing in the tree beside the two in `engine.py` and `subagent_attempt.py`. Its claim was re-derived from the code on 2026-09-14.
