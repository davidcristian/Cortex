...
**151 open, 532 closed, 683 in total.**
...
- **[R-671](tasks/671-the-widest-line-check-names-its-sinks-by-hand.md)** The widest-line check names its sinks by hand (cross-cutting). Its claim was re-derived from the code on 2026-09-19.
...
- **[R-697](tasks/697-the-drafter-is-unpriced-on-a-tool-call-and-an-answer-at-one-clock.md)** The deep tier's drafter is unpriced on a tool call and on answer text at one clock (inference-model-manager). Its claim was re-derived from the code on 2026-09-19.
...
- [R-671](tasks/671-the-widest-line-check-names-its-sinks-by-hand.md) The widest-line check names its sinks by hand. open, actionable.
...
- [R-697](tasks/697-the-drafter-is-unpriced-on-a-tool-call-and-an-answer-at-one-clock.md) The deep tier's drafter is unpriced on a tool call and on answer text at one clock. open, actionable.
