...
**117 open, 263 closed, 380 in total.**
...
- **[R-351](tasks/351-two-readings-only-a-fake-ever-produced.md)** Two of the three readings the abandonment line distinguishes are only ever arranged (seam-transport).
- **[R-354](tasks/354-two-declared-defaults-the-reducer-refuses.md)** Two kinds of declared default the constant scan cannot compare (repo-gates).
- **[R-355](tasks/355-one-variable-several-defaults-no-declaration.md)** A substitution's several spends may drift from each other with nothing declaring them (repo-gates).
- **[R-356](tasks/356-the-body-port-is-a-bare-literal.md)** The body's own listen port is a bare literal, so nothing ties the endpoint that dials it (repo-gates).
...
- **[R-365](tasks/365-a-refused-name-is-neither-missing-nor-shut.md)** A third thing a refused SELECT can mean, a name no mailbox could have, is untyped (email-confirmer).
- **[R-366](tasks/366-the-probe-fixture-and-its-test-are-untied.md)** The IMAP probe's fixture names are spelled twice and nothing ties the two spellings (repo-gates).
- **[R-369](tasks/369-the-run-deadline-under-the-queue-is-prose-only.md)** The run deadline's place under the queue for it is written only in prose (subagents).
- **[R-371](tasks/371-a-floor-and-a-sliver-are-indistinguishable.md)** A grpc that stopped flooring the reading is no longer told from one that did (seam-transport).
- **[R-372](tasks/372-the-sliver-is-unsampled-over-time.md)** The margin under the expiry bound was measured once and is sampled by nothing (seam-transport).
- **[R-373](tasks/373-a-flag-read-from-a-standard-not-a-server.md)** One of the two unselectable flags is read from a standard and from no server (email-confirmer).
...
- **[R-377](tasks/377-a-comment-restates-a-registered-value.md)** A compose comment restates a registered value and nothing holds it there (repo-gates).
- **[R-380](tasks/380-a-fires-delegates-do-not-name-the-item.md)** A fire's delegates do not name the item that fired them (tools-mcp).
...
- [R-365](tasks/365-a-refused-name-is-neither-missing-nor-shut.md) A third thing a refused SELECT can mean, a name no mailbox could have, is untyped. open, actionable.
- [R-373](tasks/373-a-flag-read-from-a-standard-not-a-server.md) One of the two unselectable flags is read from a standard and from no server. open, actionable.
...
- [R-354](tasks/354-two-declared-defaults-the-reducer-refuses.md) Two kinds of declared default the constant scan cannot compare. open, actionable.
- [R-355](tasks/355-one-variable-several-defaults-no-declaration.md) A substitution's several spends may drift from each other with nothing declaring them. open, actionable.
- [R-356](tasks/356-the-body-port-is-a-bare-literal.md) The body's own listen port is a bare literal, so nothing ties the endpoint that dials it. open, actionable.
...
- [R-366](tasks/366-the-probe-fixture-and-its-test-are-untied.md) The IMAP probe's fixture names are spelled twice and nothing ties the two spellings. open, actionable.
...
- [R-377](tasks/377-a-comment-restates-a-registered-value.md) A compose comment restates a registered value and nothing holds it there. open, actionable.
...
- [R-351](tasks/351-two-readings-only-a-fake-ever-produced.md) Two of the three readings the abandonment line distinguishes are only ever arranged. open, actionable.
...
- [R-371](tasks/371-a-floor-and-a-sliver-are-indistinguishable.md) A grpc that stopped flooring the reading is no longer told from one that did. open, actionable.
- [R-372](tasks/372-the-sliver-is-unsampled-over-time.md) The margin under the expiry bound was measured once and is sampled by nothing. open, actionable.
...
- [R-369](tasks/369-the-run-deadline-under-the-queue-is-prose-only.md) The run deadline's place under the queue for it is written only in prose. open, actionable.
...
- [R-380](tasks/380-a-fires-delegates-do-not-name-the-item.md) A fire's delegates do not name the item that fired them. open, actionable.
