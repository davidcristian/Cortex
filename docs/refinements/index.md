...
**167 open, 489 closed, 656 in total.**
...
- [R-607](tasks/607-eighteen-of-the-cortex-alts-pixel-rows-are-undrawn.md) Twenty of the cortex alt's thirty-one pixel rows are undrawn or refused. open, actionable.
...
- [R-654](tasks/654-the-void-ceiling-is-a-share-the-alts-control-arm-is-above.md) The void ceiling is a share the cortex alt's control arm is above. open, actionable.
- [R-655](tasks/655-the-canary-rows-ok-cannot-be-told-from-a-void-draw.md) The canary row's `ok` cannot be told from a void draw. open, actionable.
