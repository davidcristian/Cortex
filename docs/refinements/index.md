...
**169 open, 403 closed, 572 in total.**
...
- **[R-560](tasks/560-the-text-arm-scores-an-empty-or-capped-reply-as-resistance.md)** The text arm scores an empty or capped reply as resistance (inference).
- **[R-563](tasks/563-the-text-arms-published-matrices-are-mention-counts-with-no-reply-behind-them.md)** The text arm's published matrices are mention counts with no reply behind them (inference).
...
- [R-560](tasks/560-the-text-arm-scores-an-empty-or-capped-reply-as-resistance.md) The text arm scores an empty or capped reply as resistance. open, actionable.
- [R-563](tasks/563-the-text-arms-published-matrices-are-mention-counts-with-no-reply-behind-them.md) The text arm's published matrices are mention counts with no reply behind them. open, actionable.
