...
**90 open, 227 closed, 317 in total.**
...
- **[R-312](tasks/312-search-refusal-is-untyped.md)** A refused search reaches the model as the IMAP library's own error (email-confirmer).
...
- [R-312](tasks/312-search-refusal-is-untyped.md) A refused search reaches the model as the IMAP library's own error. open, actionable.
