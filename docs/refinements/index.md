...
**175 open, 441 closed, 616 in total.**
...
- **[R-557](tasks/557-the-engine-image-names-are-typed-in-five-places.md)** The engine image names are typed in five places (inference).
- **[R-559](tasks/559-the-cpu-row-carries-the-cpu-quota-and-not-the-memory-cap.md)** The CPU row carries the CPU quota and not the memory cap (inference).
...
- [R-555](tasks/555-the-other-four-subagent-candidates-have-no-cpu-row.md) The other four subagent candidates have no CPU row. open, actionable.
...
- [R-557](tasks/557-the-engine-image-names-are-typed-in-five-places.md) The engine image names are typed in five places. open, actionable.
...
- [R-559](tasks/559-the-cpu-row-carries-the-cpu-quota-and-not-the-memory-cap.md) The CPU row carries the CPU quota and not the memory cap. open, actionable.
...
- [R-607](tasks/607-eighteen-of-the-cortex-alts-pixel-rows-are-undrawn.md) Eighteen of the cortex alt's twenty-three pixel rows are undrawn. open, actionable.
