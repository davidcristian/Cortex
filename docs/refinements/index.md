...
**142 open, 349 closed, 491 in total.**
...
- **[R-472](tasks/472-the-membership-prefix-is-a-convention-nothing-enforces.md)** The set a subagent server joins is a naming convention nothing enforces (repo-gates).
...
- [R-472](tasks/472-the-membership-prefix-is-a-convention-nothing-enforces.md) The set a subagent server joins is a naming convention nothing enforces. open, actionable.
