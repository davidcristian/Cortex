...
**102 open, 247 closed, 349 in total.**
...
- **[R-345](tasks/345-a-refusal-that-is-not-the-only-record.md)** A model host refusal claims to be the only record of itself (inference-model-manager).
...
- [R-345](tasks/345-a-refusal-that-is-not-the-only-record.md) A model host refusal claims to be the only record of itself. open, actionable.
