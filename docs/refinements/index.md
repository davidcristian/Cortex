...
**115 open, 258 closed, 373 in total.**
...
- **[R-364](tasks/364-list-folders-offers-a-name-no-mailbox-has.md)** `list_folders` offers a name that is not a mailbox, and a refusal sends the model to it (email-confirmer).
...
- [R-364](tasks/364-list-folders-offers-a-name-no-mailbox-has.md) `list_folders` offers a name that is not a mailbox, and a refusal sends the model to it. open, actionable.
