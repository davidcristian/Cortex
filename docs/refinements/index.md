...
**156 open, 527 closed, 683 in total.**
...
- **[R-687](tasks/687-nothing-holds-the-compose-brain-to-its-settings-classes.md)** Nothing holds the compose brain to its settings classes (repo-gates). Its claim was re-derived from the code on 2026-09-17.
...
- [R-686](tasks/686-the-compose-brain-cannot-receive-most-of-its-settings.md) The compose brain cannot receive most of its own settings. landed 2026-09-17.
...
- [R-687](tasks/687-nothing-holds-the-compose-brain-to-its-settings-classes.md) Nothing holds the compose brain to its settings classes. open, actionable.
