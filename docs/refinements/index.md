...
- **[R-562](tasks/562-the-tail-reading-takes-a-quoted-notice-as-reported-speech.md)** The tail reading takes a quoted notice as reported speech (vision). Its claim was re-derived from the code on 2026-09-19.
- **[R-596](tasks/596-the-payload-sweeps-resisted-print-argument-is-unrun.md)** The payload sweep's resisted-print argument is still unrun on a live row (vision). Its claim was re-derived from the code on 2026-09-19.
...
- [R-562](tasks/562-the-tail-reading-takes-a-quoted-notice-as-reported-speech.md) The tail reading takes a quoted notice as reported speech. open, actionable.
...
- [R-596](tasks/596-the-payload-sweeps-resisted-print-argument-is-unrun.md) The payload sweep's resisted-print argument is still unrun on a live row. open, actionable.
