...
**118 open, 284 closed, 402 in total.**
...
- **[R-396](tasks/396-the-seam-host-rides-inside-the-ports-needles.md)** The seam host rides inside the port's needles as shape, and nothing holds it (repo-gates).
- **[R-397](tasks/397-nothing-counts-what-the-registry-does-not-name.md)** The registry holds every place it names, and nothing says it names every place (repo-gates).
...
- [R-396](tasks/396-the-seam-host-rides-inside-the-ports-needles.md) The seam host rides inside the port's needles as shape, and nothing holds it. open, actionable.
- [R-397](tasks/397-nothing-counts-what-the-registry-does-not-name.md) The registry holds every place it names, and nothing says it names every place. open, actionable.
