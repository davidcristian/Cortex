...
UTS-39 confusables, further encodings, footer heuristics), of which **further encodings was priced
...
escape, and nobody at all resolves a bracket-less percent-escape), leaving the tail open on the
escapes, the JSON slashes, the percent-encoded scheme and stacked references
