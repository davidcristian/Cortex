...
**109 open, 255 closed, 364 in total.**
...
- **[R-327](tasks/327-the-other-no-to-select-is-unseen.md)** The other kind of refused SELECT has never been seen on a server this repo can reach (email-confirmer).
...
- [R-327](tasks/327-the-other-no-to-select-is-unseen.md) The other kind of refused SELECT has never been seen on a server this repo can reach. open, actionable.
