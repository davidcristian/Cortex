...
**147 open, 370 closed, 517 in total.**
...
- **[R-504](tasks/504-a-declared-message-and-a-different-word-in-the-call.md)** A declared message and a different word in the call (repo-gates).
...
- [R-504](tasks/504-a-declared-message-and-a-different-word-in-the-call.md) A declared message and a different word in the call. open, actionable.
