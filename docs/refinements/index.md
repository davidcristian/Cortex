...
**171 open, 421 closed, 592 in total.**
...
- **[R-592](tasks/592-the-resisted-print-switch-has-never-been-set-on-a-live-row.md)** The resisted-print switch has never been set on a live row (vision).
...
- [R-592](tasks/592-the-resisted-print-switch-has-never-been-set-on-a-live-row.md) The resisted-print switch has never been set on a live row. open, actionable.
