...
**116 open, 259 closed, 375 in total.**
...
- **[R-374](tasks/374-two-names-the-bridge-lists-are-now-withheld.md)** Two names the Bridge lists and opens are now withheld, and nobody has looked (email-confirmer).
...
- [R-374](tasks/374-two-names-the-bridge-lists-are-now-withheld.md) Two names the Bridge lists and opens are now withheld, and nobody has looked. open, actionable.
