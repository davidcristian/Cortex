...
**94 open, 180 closed, 274 in total.**
...
- **[R-274](tasks/274-unpinned-nightly-drifts-the-coverage-gate.md)** The coverage gate's nightly is a channel, so upstream drift breaks it (repo-gates). Reopens when: a second instrumentation drift, or any nightly break that costs more to diagnose than
...
- [R-274](tasks/274-unpinned-nightly-drifts-the-coverage-gate.md) The coverage gate's nightly is a channel, so upstream drift breaks it. open, fix when it bites.
