...
**142 open, 350 closed, 492 in total.**
...
- **[R-473](tasks/473-a-built-row-is-recorded-where-it-could-be-derived.md)** A built row is recorded where it could be derived (repo-gates).
...
- **[R-478](tasks/478-two-ceilings-on-one-run-and-no-ordering.md)** Two ceilings bound one delegated run and nothing puts them in the same unit (subagents).
...
- [R-473](tasks/473-a-built-row-is-recorded-where-it-could-be-derived.md) A built row is recorded where it could be derived. open, actionable.
...
- [R-478](tasks/478-two-ceilings-on-one-run-and-no-ordering.md) Two ceilings bound one delegated run and nothing puts them in the same unit. open, actionable.
