...
**89 open, 220 closed, 309 in total.**
...
- **[R-309](tasks/309-a-silent-judge-fallback.md)** A judge that falls back to geometry says nothing (memory).
...
- [R-309](tasks/309-a-silent-judge-fallback.md) A judge that falls back to geometry says nothing. open, actionable.
