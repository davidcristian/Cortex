...
**151 open, 544 closed, 695 in total.**

## What remains

151 of these record the day their claims were last checked against the code. On every other task here, that reading is still yours to take.
...
- **[R-711](tasks/711-no-check-reads-a-task-files-slug.md)** No check reads a task file's slug (repo-checks). Its claim was checked against the code on 2026-09-22.
- **[R-712](tasks/712-a-plain-link-outside-the-backlog-is-resolved-by-no-check.md)** A plain link outside the backlog is resolved by no check (repo-checks). Its claim was checked against the code on 2026-09-22.
...
- [R-711](tasks/711-no-check-reads-a-task-files-slug.md) No check reads a task file's slug. open, actionable.
- [R-712](tasks/712-a-plain-link-outside-the-backlog-is-resolved-by-no-check.md) A plain link outside the backlog is resolved by no check. open, actionable.
