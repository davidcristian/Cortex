...
**95 open, 183 closed, 278 in total.**
...
- **[R-203](tasks/203-escalation-fault-not-remembered.md)** The brain forgetting that escalation cannot work (resource-governance). Reopens when: A deployment observed paying that stall, or a user asking why escalation never happens.
...
- [R-203](tasks/203-escalation-fault-not-remembered.md) The brain forgetting that escalation cannot work. open, fix when it bites.
