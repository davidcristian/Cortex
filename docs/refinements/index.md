...
**158 open, 390 closed, 548 in total.**
...
- **[R-548](tasks/548-an-empty-folder-read-raises-instead-of-answering-not-found.md)** A read of an empty folder raises instead of answering not-found, so the turn is tainted (email).
...
- [R-548](tasks/548-an-empty-folder-read-raises-instead-of-answering-not-found.md) A read of an empty folder raises instead of answering not-found, so the turn is tainted. open, actionable.
