...
**118 open, 291 closed, 409 in total.**
...
- **[R-409](tasks/409-a-gates-success-line-names-no-collection.md)** Every other gate reports a verdict without saying what it covered (repo-gates).
...
- [R-409](tasks/409-a-gates-success-line-names-no-collection.md) Every other gate reports a verdict without saying what it covered. open, actionable.
