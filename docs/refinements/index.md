...
**117 open, 261 closed, 378 in total.**
...
- **[R-350](tasks/350-a-failed-swap-in-says-nothing-brain-side.md)** A swap that failed on the model host says nothing in the brain's own log (inference-model-manager).
...
- [R-350](tasks/350-a-failed-swap-in-says-nothing-brain-side.md) A swap that failed on the model host says nothing in the brain's own log. open, actionable.
