...
**126 open, 325 closed, 451 in total.**
...
- **[R-446](tasks/446-the-scan-roster-is-spelled-in-seven-places.md)** The list of cross-tree scans is spelled in seven places and held in none (repo-gates). Reopens when: a scan is added, renamed or removed and one of the seven copies keeps describing the set that ran before it, which has already happened once and cost a reader the knowledge that a gate exists.
...
- [R-446](tasks/446-the-scan-roster-is-spelled-in-seven-places.md) The list of cross-tree scans is spelled in seven places and held in none. open, fix when it bites.
