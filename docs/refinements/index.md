...
**168 open, 402 closed, 570 in total.**
...
- **[R-552](tasks/552-the-uid-parameter-of-read-email-carries-no-description.md)** The uid parameter of read_email carries no description (email).
...
- [R-552](tasks/552-the-uid-parameter-of-read-email-carries-no-description.md) The uid parameter of read_email carries no description. open, actionable.
