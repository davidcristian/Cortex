...
**97 open, 185 closed, 282 in total.**

## What remains

9 of these wait on something nobody wrote down. That is a gap in the record rather than a decision, and reading one of them closes it.
...
- **[R-058](tasks/058-uts39-confusables-set.md)** Full UTS-39 confusables set (untrusted-content). No trigger was ever recorded for it.
...
- [R-058](tasks/058-uts39-confusables-set.md) Full UTS-39 confusables set. open, fix when it bites.
