...
**156 open, 526 closed, 682 in total.**
...
- **[R-685](tasks/685-a-redaction-records-no-ground.md)** A redaction records no ground an operator can count (untrusted-content). Its claim was re-derived from the code on 2026-09-17.
- **[R-686](tasks/686-the-compose-brain-cannot-receive-most-of-its-settings.md)** The compose brain cannot receive most of its own settings (cross-cutting). Its claim was re-derived from the code on 2026-09-17.
...
- [R-686](tasks/686-the-compose-brain-cannot-receive-most-of-its-settings.md) The compose brain cannot receive most of its own settings. open, actionable.
...
- [R-685](tasks/685-a-redaction-records-no-ground.md) A redaction records no ground an operator can count. open, actionable.
