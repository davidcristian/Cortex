...
- **[R-713](tasks/713-the-alts-payload-series-applications-are-called-reports.md)** ADR-0041 calls the alt's payload-series applications reports, and hand counts find some (vision). Its claim was checked against the code on 2026-09-23.
...
- [R-713](tasks/713-the-alts-payload-series-applications-are-called-reports.md) ADR-0041 calls the alt's payload-series applications reports, and hand counts find some. open, actionable.
