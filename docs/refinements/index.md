...
94 of these record the day their claims were last re-derived from the code. On every other task here, that reading is still yours to take.

### Actionable now (12)

- **[R-452](tasks/452-a-roster-written-in-descriptions-is-held-by-nobody.md)** A roster written in descriptions rather than names is held by nobody (repo-gates).
...
- [R-452](tasks/452-a-roster-written-in-descriptions-is-held-by-nobody.md) A roster written in descriptions rather than names is held by nobody. open, actionable.
