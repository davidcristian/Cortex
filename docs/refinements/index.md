...
87 of these record the day their claims were last re-derived from the code. On every other task here, that reading is still yours to take.
...
- **[R-627](tasks/627-the-cpu-rows-wall-clock-is-not-reproducible-across-sittings.md)** The CPU row's wall clock is not reproducible across sittings (inference). Its claim was re-derived from the code on 2026-09-10.
...
- [R-627](tasks/627-the-cpu-rows-wall-clock-is-not-reproducible-across-sittings.md) The CPU row's wall clock is not reproducible across sittings. open, actionable.
