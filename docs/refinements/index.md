...
**142 open, 348 closed, 490 in total.**
...
- **[R-489](tasks/489-a-declared-logger-name-and-a-different-name-in-the-call.md)** A declared logger name and a different name in the call (repo-gates).
...
- [R-489](tasks/489-a-declared-logger-name-and-a-different-name-in-the-call.md) A declared logger name and a different name in the call. open, actionable.
