...
**166 open, 466 closed, 632 in total.**
...
- **[R-632](tasks/632-the-write-run-judges-the-links-of-the-index-it-replaces.md)** The write run judges the links of the index it replaces (repo-gates).
...
- [R-632](tasks/632-the-write-run-judges-the-links-of-the-index-it-replaces.md) The write run judges the links of the index it replaces. open, actionable.
