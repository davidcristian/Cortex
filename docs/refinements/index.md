...
**96 open, 184 closed, 280 in total.**

## What remains

10 of these wait on something nobody wrote down. That is a gap in the record rather than a decision, and reading one of them closes it.
...
- **[R-057](tasks/057-whitespace-split-hosts.md)** Whitespace-split hosts (untrusted-content). No trigger was ever recorded for it.
...
- [R-057](tasks/057-whitespace-split-hosts.md) Whitespace-split hosts. open, fix when it bites.
