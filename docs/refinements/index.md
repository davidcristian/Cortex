...
**95 open, 235 closed, 330 in total.**
...
- **[R-330](tasks/330-a-bool-loses-which-model-failed.md)** A bool loses which of two models the restore failed on (inference-model-manager).
...
- [R-330](tasks/330-a-bool-loses-which-model-failed.md) A bool loses which of two models the restore failed on. open, actionable.
