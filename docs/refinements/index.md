...
**154 open, 384 closed, 538 in total.**
...
- **[R-537](tasks/537-the-declaration-field-names-are-bare-literals-on-both-sides.md)** The two field names a declared source is written under are bare literals on both sides (repo-gates).
...
- [R-537](tasks/537-the-declaration-field-names-are-bare-literals-on-both-sides.md) The two field names a declared source is written under are bare literals on both sides. open, actionable.
