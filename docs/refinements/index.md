...
**94 open, 233 closed, 327 in total.**
...
- **[R-326](tasks/326-a-line-that-names-nothing-it-happened-to.md)** A line that names nothing it happened to (cross-cutting).
...
- [R-326](tasks/326-a-line-that-names-nothing-it-happened-to.md) A line that names nothing it happened to. open, actionable.
