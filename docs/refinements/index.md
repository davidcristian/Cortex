...
**153 open, 522 closed, 675 in total.**

## What remains

153 of these record the day their claims were last re-derived from the code. On every other task here, that reading is still yours to take.
...
- [R-678](tasks/678-a-rows-card-reading-misses-the-ceiling-between-its-ends.md) A row's card reading misses what the ceiling did between its ends. open, actionable.
