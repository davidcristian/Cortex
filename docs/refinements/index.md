...
**96 open, 194 closed, 290 in total.**
...
- **[R-290](tasks/290-the-export-names-its-tool-not-its-compiler.md)** The coverage export names its tool and never its compiler (repo-gates). Reopens when: a coverage failure where the relayed `rustc` line is not enough to settle whether the
