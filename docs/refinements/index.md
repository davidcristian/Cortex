...
**95 open, 246 closed, 341 in total.**
...
- **[R-328](tasks/328-a-failed-turn-cannot-name-itself.md)** A failed turn can name its session but never itself (session-read-seam).
...
- [R-328](tasks/328-a-failed-turn-cannot-name-itself.md) A failed turn can name its session but never itself. open, actionable.
