...
**145 open, 357 closed, 502 in total.**
...
- **[R-432](tasks/432-the-image-arm-has-never-run-at-two-sizes.md)** Nobody has measured whether the image arm's result depends on the picture's size (vision).
- **[R-482](tasks/482-the-sentence-is-one-wording-for-every-entry.md)** One sentence is appended for every roster entry and the entries do not agree about it (subagents).
- **[R-484](tasks/484-the-control-arm-is-held-to-no-floor.md)** The raw arm every envelope reading is measured against is held to no floor (subagents).
- **[R-485](tasks/485-a-roster-description-never-says-whether-the-entry-answers.md)** A roster entry's description tells the cortex how fast it is and never whether it answers (subagents).
- **[R-490](tasks/490-a-declared-log-message-may-be-spelled-again-in-the-call-that-logs-it.md)** A declared log message may be spelled again in the call that logs it (repo-gates).
- **[R-491](tasks/491-the-guard-holding-a-declared-logger-to-its-call-names-two-sinks-by-hand.md)** The guard holding a declared logger to its call names two sinks by hand (repo-gates).
- **[R-493](tasks/493-a-base-may-declare-a-volume-through-onbuild.md)** A base may declare a volume through ONBUILD (repo-gates).
- **[R-499](tasks/499-the-rendering-predictor-is-asserted-nowhere.md)** The rendering that predicts a tier's constrained verdict is printed and never asserted (inference).
- **[R-500](tasks/500-the-garbled-channel-marker-has-no-attributed-cause.md)** The garbled channel marker that eats a delegated answer has no attributed cause (inference).
...
- [R-499](tasks/499-the-rendering-predictor-is-asserted-nowhere.md) The rendering that predicts a tier's constrained verdict is printed and never asserted. open, actionable.
- [R-500](tasks/500-the-garbled-channel-marker-has-no-attributed-cause.md) The garbled channel marker that eats a delegated answer has no attributed cause. open, actionable.
...
- [R-490](tasks/490-a-declared-log-message-may-be-spelled-again-in-the-call-that-logs-it.md) A declared log message may be spelled again in the call that logs it. open, actionable.
- [R-491](tasks/491-the-guard-holding-a-declared-logger-to-its-call-names-two-sinks-by-hand.md) The guard holding a declared logger to its call names two sinks by hand. open, actionable.
...
- [R-493](tasks/493-a-base-may-declare-a-volume-through-onbuild.md) A base may declare a volume through ONBUILD. open, actionable.
...
- [R-482](tasks/482-the-sentence-is-one-wording-for-every-entry.md) One sentence is appended for every roster entry and the entries do not agree about it. open, actionable.
...
- [R-484](tasks/484-the-control-arm-is-held-to-no-floor.md) The raw arm every envelope reading is measured against is held to no floor. open, actionable.
- [R-485](tasks/485-a-roster-description-never-says-whether-the-entry-answers.md) A roster entry's description tells the cortex how fast it is and never whether it answers. open, actionable.
...
- [R-432](tasks/432-the-image-arm-has-never-run-at-two-sizes.md) Nobody has measured whether the image arm's result depends on the picture's size. open, actionable.
