...
**129 open, 328 closed, 457 in total.**
...
- **[R-456](tasks/456-a-constrained-request-loses-the-thinking-lever.md)** A constrained request loses the thinking lever the subagent tier is held off by (subagents).
...
- [R-456](tasks/456-a-constrained-request-loses-the-thinking-lever.md) A constrained request loses the thinking lever the subagent tier is held off by. open, actionable.
- [R-457](tasks/457-the-caps-derivation-on-the-shape-that-ships.md) The token cap's derivation is written against a shape the default stack does not run. open, a seam or port change comes first.
