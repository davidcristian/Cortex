...
**92 open, 230 closed, 322 in total.**
...
- **[R-317](tasks/317-shipped-handler-drops-every-field.md)** The shipped handler drops every structured field (cross-cutting).
...
- [R-317](tasks/317-shipped-handler-drops-every-field.md) The shipped handler drops every structured field. open, actionable.
