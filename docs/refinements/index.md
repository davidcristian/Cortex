...
**150 open, 545 closed, 695 in total.**
...
- **[R-711](tasks/711-rust-and-typescript-strings-are-outside-the-prose-check.md)** Rust and TypeScript strings are outside the prose check (repo-checks). Its claim was checked against the code on 2026-09-22.
...
- **[R-708](tasks/708-the-overlay-cannot-say-what-a-turn-waits-for.md)** The overlay cannot say what a turn is waiting for (body-overlay). Its claim was checked against the code on 2026-09-22.
...
- [R-708](tasks/708-the-overlay-cannot-say-what-a-turn-waits-for.md) The overlay cannot say what a turn is waiting for. open, needs a port change first.
...
- [R-711](tasks/711-rust-and-typescript-strings-are-outside-the-prose-check.md) Rust and TypeScript strings are outside the prose check. open, actionable.
