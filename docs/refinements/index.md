...
**142 open, 346 closed, 488 in total.**
...
- **[R-487](tasks/487-the-tool-audits-message-is-spelled-in-three-places-and-held-in-none.md)** The tool audit's message is spelled in three places and held in none (repo-gates).
- **[R-488](tasks/488-a-declared-logger-name-is-never-held-to-the-call-that-passes-it.md)** A declared logger name is never held to the call that passes it (repo-gates).
...
- [R-487](tasks/487-the-tool-audits-message-is-spelled-in-three-places-and-held-in-none.md) The tool audit's message is spelled in three places and held in none. open, actionable.
- [R-488](tasks/488-a-declared-logger-name-is-never-held-to-the-call-that-passes-it.md) A declared logger name is never held to the call that passes it. open, actionable.
