...
**104 open, 253 closed, 357 in total.**
...
- **[R-349](tasks/349-a-mutation-table-nobody-replayed.md)** Every mutation table in the record is the hand that wrote it reporting on itself (cross-cutting).
...
- [R-349](tasks/349-a-mutation-table-nobody-replayed.md) Every mutation table in the record is the hand that wrote it reporting on itself. open, actionable.
