...
**136 open, 334 closed, 470 in total.**
...
- **[R-443](tasks/443-a-built-rows-answer-comes-from-whatever-this-machine-last-built.md)** A built row's answer comes from whatever this machine last built (repo-gates).
- **[R-453](tasks/453-the-harness-reads-one-field-off-a-line-it-has-whole.md)** The harness reads one field off a line it has whole (cross-cutting).
...
- **[R-459](tasks/459-what-the-envelope-costs-the-answer.md)** Nothing prices what the reply envelope costs the answer rather than the tokens (subagents).
- **[R-464](tasks/464-why-a-grammar-restores-the-trace.md)** Why a schema restores a trace the same server just suppressed is unknown (inference).
- **[R-465](tasks/465-the-switch-across-the-lineup.md)** Two picks are not a rule about which shapes honour the thinking switch (inference).
- **[R-467](tasks/467-the-hosted-subagent-tier-meets-the-flag-rule-by-hand.md)** The hosted subagent tier meets the flag rule by hand rather than by the rule (repo-gates).
...
- [R-453](tasks/453-the-harness-reads-one-field-off-a-line-it-has-whole.md) The harness reads one field off a line it has whole. open, actionable.
...
- [R-464](tasks/464-why-a-grammar-restores-the-trace.md) Why a schema restores a trace the same server just suppressed is unknown. open, actionable.
- [R-465](tasks/465-the-switch-across-the-lineup.md) Two picks are not a rule about which shapes honour the thinking switch. open, actionable.
...
- [R-443](tasks/443-a-built-rows-answer-comes-from-whatever-this-machine-last-built.md) A built row's answer comes from whatever this machine last built. open, actionable.
...
- [R-467](tasks/467-the-hosted-subagent-tier-meets-the-flag-rule-by-hand.md) The hosted subagent tier meets the flag rule by hand rather than by the rule. open, actionable.
...
- [R-459](tasks/459-what-the-envelope-costs-the-answer.md) Nothing prices what the reply envelope costs the answer rather than the tokens. open, actionable.
