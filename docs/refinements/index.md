...
**172 open, 421 closed, 593 in total.**
...
- **[R-593](tasks/593-the-bodys-bind-port-can-be-declared-now-the-shell-compiles.md)** The body's bind port can be declared now the shell compiles (repo-gates).
...
- [R-593](tasks/593-the-bodys-bind-port-can-be-declared-now-the-shell-compiles.md) The body's bind port can be declared now the shell compiles. open, actionable.
