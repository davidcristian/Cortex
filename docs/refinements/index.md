...
**151 open, 530 closed, 681 in total.**
...
- **[R-692](tasks/692-the-defaults-gate-counts-a-file-it-could-not-read-as-a-variable.md)** The defaults gate counts a file it could not read as a variable (repo-gates). Its claim was re-derived from the code on 2026-09-19.
...
- [R-692](tasks/692-the-defaults-gate-counts-a-file-it-could-not-read-as-a-variable.md) The defaults gate counts a file it could not read as a variable. open, actionable.
