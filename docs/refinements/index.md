...
**144 open, 354 closed, 498 in total.**
...
- **[R-475](tasks/475-a-tier-can-be-asked-what-its-template-answers.md)** A tier can be asked at boot which of its own bounds are safe, and nothing asks (inference).
...
- [R-475](tasks/475-a-tier-can-be-asked-what-its-template-answers.md) A tier can be asked at boot which of its own bounds are safe, and nothing asks. open, actionable.
