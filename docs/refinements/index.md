...
**93 open, 231 closed, 324 in total.**
...
- **[R-323](tasks/323-a-field-spelled-into-its-own-message.md)** A field spelled into its own message now prints twice (cross-cutting).
...
- [R-323](tasks/323-a-field-spelled-into-its-own-message.md) A field spelled into its own message now prints twice. open, actionable.
