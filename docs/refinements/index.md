...
**166 open, 464 closed, 630 in total.**
...
104 of these record the day their claims were last re-derived from the code. On every other task here, that reading is still yours to take.
...
- **[R-073](tasks/073-fence-without-block-recall.md)** Fence-without-block recall mode (untrusted-content). Reopens when: taint-spread on tangential recall proving too blunt. Its claim was re-derived from the code on 2026-09-11.
- **[R-082](tasks/082-replayed-quoted-injection.md)** Quoted injection replayed by the plain history window (untrusted-content). Reopens when: the first design that needs a persisted per-turn taint or provenance marker. Its claim was re-derived from the code on 2026-09-11.
...
- [R-630](tasks/630-the-settled-cells-are-undrawn-across-loads.md) The cells whose published reading is one load's answer are undrawn across loads. open, actionable.
