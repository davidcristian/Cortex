...
- **[R-406](tasks/406-the-carried-run-is-measured-over-a-whole-file.md)** The run an unfound needle quotes back is measured over a whole file, so it overstates itself (repo-gates). Its claim was re-derived from the code on 2026-09-17.
...
- **[R-656](tasks/656-a-short-count-names-no-line.md)** A count that is short by one names no line to open (repo-gates). Its claim was re-derived from the code on 2026-09-17.
...
- [R-406](tasks/406-the-carried-run-is-measured-over-a-whole-file.md) The run an unfound needle quotes back is measured over a whole file, so it overstates itself. open, actionable.
...
- [R-656](tasks/656-a-short-count-names-no-line.md) A count that is short by one names no line to open. open, actionable.
