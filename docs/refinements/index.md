...
**137 open, 340 closed, 477 in total.**
...
- **[R-457](tasks/457-the-caps-derivation-on-the-shape-that-ships.md)** The token cap's derivation is written against a shape the default stack does not run (subagents).
...
- [R-457](tasks/457-the-caps-derivation-on-the-shape-that-ships.md) The token cap's derivation is written against a shape the default stack does not run. open, actionable.
