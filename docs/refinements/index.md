...
**149 open, 556 closed, 705 in total.**
...
- **[R-561](tasks/561-a-token-beside-the-models-own-words-is-read-as-a-description.md)** A token beside the model's own words on one line is read as a description (vision). Its claim was checked against the code on 2026-09-24.
- **[R-581](tasks/581-the-six-line-attacks-have-no-written-hand-rule.md)** The six line attacks have no written hand rule (inference). Its claim was checked against the code on 2026-09-24.
...
- [R-581](tasks/581-the-six-line-attacks-have-no-written-hand-rule.md) The six line attacks have no written hand rule. open, actionable.
...
- [R-727](tasks/727-the-sampled-text-rows-keep-no-counted-reply-in-the-recorded-set.md) The sampled text rows keep no counted reply in the recorded set. open, actionable.
...
- [R-561](tasks/561-a-token-beside-the-models-own-words-is-read-as-a-description.md) A token beside the model's own words on one line is read as a description. open, actionable.
