...
**117 open, 262 closed, 379 in total.**
...
- **[R-352](tasks/352-a-dispatch-names-no-call.md)** A dispatched call's own id reaches no line (tools-mcp).
...
- [R-352](tasks/352-a-dispatch-names-no-call.md) A dispatched call's own id reaches no line. open, actionable.
