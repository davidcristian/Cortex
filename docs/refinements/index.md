...
**114 open, 275 closed, 389 in total.**
...
- **[R-384](tasks/384-the-probe-account-is-spelled-twice.md)** The probe's account name is spelled in the suite and again inside the script's mail root (repo-gates).
...
- [R-384](tasks/384-the-probe-account-is-spelled-twice.md) The probe's account name is spelled in the suite and again inside the script's mail root. open, actionable.
