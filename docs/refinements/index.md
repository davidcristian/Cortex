...
**119 open, 288 closed, 407 in total.**
...
- **[R-391](tasks/391-a-fault-that-names-one-line-twice.md)** A compose-defaults fault that names one line twice says nothing about the note behind it (repo-gates).
...
- **[R-404](tasks/404-the-registrys-own-shape-is-counted-by-hand.md)** The registry's own shape is counted by hand, and goes stale on the next row (repo-gates).
- **[R-407](tasks/407-three-held-bounds-and-an-unheld-ordering.md)** Three bounds are held as three values and the ordering they are stated in is held by nothing (repo-gates).
...
- [R-391](tasks/391-a-fault-that-names-one-line-twice.md) A compose-defaults fault that names one line twice says nothing about the note behind it. open, actionable.
...
- [R-404](tasks/404-the-registrys-own-shape-is-counted-by-hand.md) The registry's own shape is counted by hand, and goes stale on the next row. open, actionable.
...
- [R-407](tasks/407-three-held-bounds-and-an-unheld-ordering.md) Three bounds are held as three values and the ordering they are stated in is held by nothing. open, actionable.
