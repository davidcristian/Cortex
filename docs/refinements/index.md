...
**150 open, 555 closed, 705 in total.**
...
- [R-707](tasks/707-model-read-texts-keep-banned-words.md) Texts a model reads keep words the prose table bans. open, actionable.
