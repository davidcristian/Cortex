...
**139 open, 342 closed, 481 in total.**
...
- **[R-481](tasks/481-the-sentence-is-measured-on-one-pick.md)** The sentence every constrained subagent now carries is measured on one pick (subagents).
...
- **[R-480](tasks/480-a-narrated-reply-arrives-as-an-answer.md)** A reply that is a plan still arrives as an answer, and nothing says so (subagents). Reopens when: a delegated reply that is a plan is seen reaching a cortex turn and shaping it, which is what would make this cost something rather than merely be true; or a roster pick lands whose answer rate under the shipped sentence is low enough that the quiet failures are common again, meaning far enough below the 84 of 89 measured on the default pick that a reader would notice one.
...
- [R-481](tasks/481-the-sentence-is-measured-on-one-pick.md) The sentence every constrained subagent now carries is measured on one pick. open, actionable.
