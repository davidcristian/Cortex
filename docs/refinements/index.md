...
**145 open, 358 closed, 503 in total.**
...
- **[R-503](tasks/503-a-declared-log-message-is-held-to-its-call-by-one-hand-named-assertion.md)** A declared log message is held to its call by one hand named assertion (repo-gates).
...
- [R-503](tasks/503-a-declared-log-message-is-held-to-its-call-by-one-hand-named-assertion.md) A declared log message is held to its call by one hand named assertion. open, actionable.
