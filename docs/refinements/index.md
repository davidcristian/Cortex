...
**167 open, 475 closed, 642 in total.**
...
- **[R-641](tasks/641-the-shipped-sentence-hands-the-report-back-on-a-summarization.md)** The shipped sentence hands the report back on a summarization (subagents).
...
- [R-642](tasks/642-the-engines-prompt-cache-may-grow-to-the-whole-memory-cap.md) The engine's prompt cache may grow to the whole memory cap of the container it runs in. open, actionable.
...
- [R-641](tasks/641-the-shipped-sentence-hands-the-report-back-on-a-summarization.md) The shipped sentence hands the report back on a summarization. open, actionable.
