...
110 of these record the day their claims were last re-derived from the code. On every other task here, that reading is still yours to take.
...
- **[R-011](tasks/011-stylesheet-outside-line-cap.md)** The overlay stylesheet outside the line cap (repo-gates). Reopens when: An edit landing in the wrong cascade position, or a second stylesheet appearing. Its claim was re-derived from the code on 2026-09-11.
...
- **[R-097](tasks/097-cross-encoder-rank.md)** A cross-encoder rank (memory). Reopens when: A measured shortfall of the judge on a real corpus, or a latency budget it cannot meet. Its claim was re-derived from the code on 2026-09-11.
