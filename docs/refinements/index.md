...
**141 open, 344 closed, 485 in total.**
...
- **[R-469](tasks/469-the-trails-logger-name-is-spelled-in-three-places-and-held-in-none.md)** The trail's logger name is spelled in three places and held in none (repo-gates). Reopens when: the sink's logger is renamed, or a third document tells an operator to select the trail by logger name
...
- [R-469](tasks/469-the-trails-logger-name-is-spelled-in-three-places-and-held-in-none.md) The trail's logger name is spelled in three places and held in none. open, fix when it bites.
