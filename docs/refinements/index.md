...
**94 open, 181 closed, 275 in total.**
...
- **[R-206](tasks/206-finish-reason-not-carried.md)** A finish reason the port does not carry (resource-governance). Reopens when: The first capped delegated reply that a reader mistakes for a finished one.
...
- **[R-273](tasks/273-index-anchor-never-checked.md)** A pointer's anchor is never checked (repo-gates). Reopens when: the first rename of an area or a sitting, or the first area whose last task moves out of it, either of which leaves every pointer aimed at a heading that is no longer rendered while the link itself still resolves.
...
- [R-273](tasks/273-index-anchor-never-checked.md) A pointer's anchor is never checked. open, fix when it bites.
...
- [R-206](tasks/206-finish-reason-not-carried.md) A finish reason the port does not carry. open, fix when it bites.
