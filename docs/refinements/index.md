...
**149 open, 530 closed, 679 in total.**
...
- **[R-689](tasks/689-the-replay-pool-holds-bodies-that-carry-no-table.md)** The replay pool holds bodies that carry no table (repo-gates). Its claim was re-derived from the code on 2026-09-19.
...
- [R-689](tasks/689-the-replay-pool-holds-bodies-that-carry-no-table.md) The replay pool holds bodies that carry no table. open, actionable.
