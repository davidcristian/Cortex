...
**128 open, 327 closed, 455 in total.**
...
- **[R-431](tasks/431-the-token-cap-fires-on-the-shape-that-ships.md)** The token cap fired on a narrow subtask running the shape this repo ships by default (subagents).
...
- [R-431](tasks/431-the-token-cap-fires-on-the-shape-that-ships.md) The token cap fired on a narrow subtask running the shape this repo ships by default. open, actionable.
