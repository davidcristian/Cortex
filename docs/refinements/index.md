...
**117 open, 281 closed, 398 in total.**
...
- **[R-376](tasks/376-the-bridge-flag-reading-is-one-account.md)** The kept half of the folder filter is proved only on a server nobody here can configure (email-confirmer).
...
- **[R-388](tasks/388-the-headroom-suite-spells-its-own-constant.md)** The headroom suite spells the edge it now declares four more times, in prose and in an assertion (repo-gates).
...
- [R-376](tasks/376-the-bridge-flag-reading-is-one-account.md) The kept half of the folder filter is proved only on a server nobody here can configure. open, actionable.
...
- [R-388](tasks/388-the-headroom-suite-spells-its-own-constant.md) The headroom suite spells the edge it now declares four more times, in prose and in an assertion. open, actionable.
