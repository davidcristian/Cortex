...
**93 open, 211 closed, 304 in total.**
...
- **[R-304](tasks/304-spill-rides-the-residency-report.md)** A spilled handoff is only ever in the log (inference-model-manager).
...
- [R-304](tasks/304-spill-rides-the-residency-report.md) A spilled handoff is only ever in the log. open, actionable.
