...
**124 open, 321 closed, 445 in total.**
...
- **[R-442](tasks/442-nothing-holds-the-live-check-roster-to-the-suite.md)** Nothing holds the live check roster in the module contract to the suite it describes (repo-gates). Reopens when: a live check is added, renamed or removed and the module contract keeps describing the set that ran before it, which is when a reader picking the suite up is told the wrong thing.
...
- [R-442](tasks/442-nothing-holds-the-live-check-roster-to-the-suite.md) Nothing holds the live check roster in the module contract to the suite it describes. open, fix when it bites.
