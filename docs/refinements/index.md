...
**144 open, 558 closed, 702 in total.**
...
- [R-725](tasks/725-the-refused-search-correction-is-read-before-the-model-writes-its-next-query.md) The refused-search correction is read before the model writes its next query. open, actionable.
...
- [R-720](tasks/720-the-window-size-sentence-is-unmeasured.md) The window size sentence is unmeasured. open, actionable.
