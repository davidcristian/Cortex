...
**123 open, 319 closed, 442 in total.**
...
- **[R-437](tasks/437-a-volume-added-to-a-dockerfile-here-moves-the-same-record.md)** A VOLUME added to a Dockerfile here moves the same record, from inside the tree (repo-gates).
- **[R-438](tasks/438-a-documented-log-sample-can-still-print-the-wrong-fields.md)** A documented log sample can still print the wrong fields (repo-gates).
...
- [R-437](tasks/437-a-volume-added-to-a-dockerfile-here-moves-the-same-record.md) A VOLUME added to a Dockerfile here moves the same record, from inside the tree. open, actionable.
- [R-438](tasks/438-a-documented-log-sample-can-still-print-the-wrong-fields.md) A documented log sample can still print the wrong fields. open, actionable.
