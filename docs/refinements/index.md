...
**144 open, 560 closed, 704 in total.**

## What remains

144 of these record the day their claims were last checked against the code. On every other task here, that reading is still yours to take.
...
- **[R-732](tasks/732-a-predicated-ending-with-words-after-the-notice-has-no-hand-rule.md)** A predicated ending with words after the notice has no hand rule (vision). Its claim was checked against the code on 2026-09-25.
...
- **[R-251](tasks/251-user-attached-image-path.md)** The user-attached image path (vision). Its claim was checked against the code on 2026-09-25.
...
- [R-607](tasks/607-eighteen-of-the-cortex-alts-pixel-rows-are-undrawn.md) Eleven of the cortex alt's thirty-six pixel rows are undrawn. open, actionable.
...
- [R-732](tasks/732-a-predicated-ending-with-words-after-the-notice-has-no-hand-rule.md) A predicated ending with words after the notice has no hand rule. open, actionable.
