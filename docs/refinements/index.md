...
52 of these record the day their claims were last re-derived from the code. On every other task here, that reading is still yours to take.
...
- [R-609](tasks/609-a-declared-mime-type-may-now-disagree-with-the-bytes-it-labels.md) A declared mime type may now disagree with the bytes it labels. open, fix when it bites.
