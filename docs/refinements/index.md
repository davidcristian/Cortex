...
**94 open, 232 closed, 326 in total.**
...
- **[R-318](tasks/318-a-folder-refusal-is-untyped.md)** A folder no mailbox has reaches the model as the IMAP library's own sentence (email-confirmer).
...
- [R-318](tasks/318-a-folder-refusal-is-untyped.md) A folder no mailbox has reaches the model as the IMAP library's own sentence. open, actionable.
