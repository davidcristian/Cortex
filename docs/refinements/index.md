...
**164 open, 493 closed, 657 in total.**
...
130 of these record the day their claims were last re-derived from the code. On every other task here, that reading is still yours to take.

### Actionable now (4)

- **[R-607](tasks/607-eighteen-of-the-cortex-alts-pixel-rows-are-undrawn.md)** Twenty of the cortex alt's thirty-one pixel rows are undrawn or refused (inference). Its claim was re-derived from the code on 2026-09-13.
