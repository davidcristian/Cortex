...
**156 open, 512 closed, 668 in total.**

## What remains

156 of these record the day their claims were last re-derived from the code. On every other task here, that reading is still yours to take.
...
- **[R-110](tasks/110-prefill-second-witness.md)** Prefill as the second witness of a spill (inference-model-manager). Reopens when: A spill that decode misses, or a deployment whose deep answers are short enough that decode rarely clears `MIN_CADENCE_TOKENS`. Its claim was re-derived from the code on 2026-09-15.
