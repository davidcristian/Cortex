...
**134 open, 332 closed, 466 in total.**
...
- **[R-462](tasks/462-nothing-enumerates-the-subagent-servers-this-repo-starts.md)** Nothing enumerates the subagent servers this repo starts, so the pair is held per file by hand (repo-gates).
...
- [R-462](tasks/462-nothing-enumerates-the-subagent-servers-this-repo-starts.md) Nothing enumerates the subagent servers this repo starts, so the pair is held per file by hand. open, actionable.
