...
**122 open, 312 closed, 434 in total.**
...
- **[R-433](tasks/433-a-mutable-image-tag-moves-under-the-recorded-answer.md)** A mutable image tag can move under the recorded answer and nothing notices (repo-gates).
- **[R-434](tasks/434-the-stub-check-reads-one-direction-and-one-stub.md)** The seam-stub check reads one direction, and only one of the two stubs (seam-transport).
...
- [R-433](tasks/433-a-mutable-image-tag-moves-under-the-recorded-answer.md) A mutable image tag can move under the recorded answer and nothing notices. open, actionable.
...
- [R-434](tasks/434-the-stub-check-reads-one-direction-and-one-stub.md) The seam-stub check reads one direction, and only one of the two stubs. open, actionable.
