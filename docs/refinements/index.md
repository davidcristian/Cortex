...
**144 open, 355 closed, 499 in total.**
...
- **[R-479](tasks/479-the-reasoning-budget-held-until-the-prompt-pushed.md)** The tier's reasoning-off flag held on every run until a firmer prompt pushed on it (inference).
...
- **[R-492](tasks/492-the-embedder-names-its-artifact-outside-the-family.md)** The embedder names its artifact outside the family the naming rule enforces (repo-gates).
...
- [R-479](tasks/479-the-reasoning-budget-held-until-the-prompt-pushed.md) The tier's reasoning-off flag held on every run until a firmer prompt pushed on it. open, actionable.
...
- [R-492](tasks/492-the-embedder-names-its-artifact-outside-the-family.md) The embedder names its artifact outside the family the naming rule enforces. open, actionable.
