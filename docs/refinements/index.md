...
**170 open, 459 closed, 629 in total.**
...
- **[R-332](tasks/332-the-recall-judge-asks-for-an-unpinned-model.md)** The recall judge asks for a model id nothing pins (memory).
...
- [R-332](tasks/332-the-recall-judge-asks-for-an-unpinned-model.md) The recall judge asks for a model id nothing pins. open, actionable.
