...
- **A URL spelled in the fullwidth and CJK twins of its own punctuation landed 2026-08-08
  ([ADR-0015 eighth addendum](../adr/ADR-0015-output-guardrail.md)), found while measuring the
  ...
  **both** policies were blind to them, the severe shape the seventh addendum's bracket asymmetry
  ...
  this one.
- **The scheme separator spelled as a bracketless HTML character reference landed 2026-08-08
  ([ADR-0015 ninth addendum](../adr/ADR-0015-output-guardrail.md)), the leftover the entry above
