...
Recorded in the [ADR-0025 badge addendum](../../adr/ADR-0025-scheduling-reminders.md). The deferral was
...
recorded **provenance across the stores** entry ([untrusted-content.md](../index.md#untrusted-content))
