...
- 2026-08-27: opened by the close of
  [R-454](454-the-readers-search-texts-are-not-tied-to-the-sink-that-writes.md), whose search text for the message is
...
- 2026-08-28: closed, as
  ...
  [R-486](486-the-tool-audits-logger-name-is-written-in-four-places.md).
