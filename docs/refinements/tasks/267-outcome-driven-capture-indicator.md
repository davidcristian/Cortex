...
[subagents.md](../index.md#subagents), and it fixed one defect found in passing: the reduced-motion block clamped `*`, which does
...
- 2026-07-19: written down from the vision slice's audit, one of the three entries that took the
  ...
  honestly say the assistant asked to look. The index adds that this dot is one of the three consent
  surfaces that justify shipping capture ungated.
