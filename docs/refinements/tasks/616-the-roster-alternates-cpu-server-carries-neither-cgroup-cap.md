...
- 2026-09-08: opened by re-reading
  [R-559](559-the-cpu-row-carries-the-cpu-quota-and-not-the-memory-cap.md), which measured the
...
- 2026-09-11: read against the rendered stack. `docker compose config` over the base, subagents and
  ...
  night, recorded in
  [R-628](628-the-subagent-cpu-servers-thread-count-is-not-pinned-to-its-quota.md), measured the
...
- 2026-09-11: done, in one change with the thread count, which also closed
  [R-628](628-the-subagent-cpu-servers-thread-count-is-not-pinned-to-its-quota.md). The previous
