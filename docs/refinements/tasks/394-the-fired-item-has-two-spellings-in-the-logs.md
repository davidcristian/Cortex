...
This is the same shape as [339](339-two-spellings-of-one-conversation.md), and the answer needs
...
- 2026-08-24: landed as the rename to `item_id`, decided together with
  ...
  the dispatch stamp's own name for it. **The objection this entry raised does not survive a reading of the
  ...
  precludes was the wrong half to preserve, since these lines record the brain's own work rather
  than a message it sent.
  ...
  a fourth arriving under another name makes the gate fail; what that registry does not reach is a
  module nobody has listed, filed as [R-416](416-a-new-log-line-can-name-its-work-anything.md). Tabled in the
