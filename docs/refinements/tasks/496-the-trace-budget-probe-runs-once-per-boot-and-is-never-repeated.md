...
- 2026-08-29: opened by the close of
  [R-474](474-the-ports-thinking-switch-could-be-sent-as-a-request-value.md), which cached the answer on the
...
- 2026-09-12: closed as the documented repair. The GPU runbook's request-budget section now has a
  ...
  already exists, is [R-648](648-nothing-asks-the-trace-setting-again-when-the-engine-moves.md).
