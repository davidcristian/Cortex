...
`SeamConfirmer` sends the confirmation exchange over the `Converse` stream to the overlay's
...
- 2026-07-08: `SeamConfirmer` shipped, sending the confirmation exchange over the `Converse`
