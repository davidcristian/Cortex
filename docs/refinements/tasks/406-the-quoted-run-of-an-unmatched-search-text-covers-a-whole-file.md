...
- 2026-08-23: opened by the close of
  [R-403](403-an-unmatched-search-text-fails-the-wrong-entry.md), which measured this while writing the
...
- 2026-09-17: closed. `scripts/linereadings.py` reads every line from both ends of the search text,
  ...
  span two lines, filed as [R-680](680-a-search-string-spanning-two-lines-keeps-the-whole-file-run.md). The
