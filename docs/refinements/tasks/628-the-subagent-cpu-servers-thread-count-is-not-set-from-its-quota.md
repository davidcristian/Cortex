...
([R-616](616-the-roster-alternates-cpu-server-has-neither-cgroup-cap.md)).
...
- 2026-09-11: read against
  [R-616](616-the-roster-alternates-cpu-server-has-neither-cgroup-cap.md). The alternate ran
...
- 2026-09-11: done, with the default decided on the pair's evidence. The three questions above were
  ...
  [R-616](616-the-roster-alternates-cpu-server-has-neither-cgroup-cap.md). The harness's CPU row
