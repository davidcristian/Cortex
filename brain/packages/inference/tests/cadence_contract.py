"""Shared ``InferenceBackend`` decode-cadence checks, run over every implementation of the port."""
...
async def check_reports_the_servers_rate(subject: BackendUnderTest) -> None:
    """A backend whose engine reported timings emits exactly one cadence, holding them."""
