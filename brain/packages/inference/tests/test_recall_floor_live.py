...
# The thresholds the run prints. A floor is a cosine, so the range is the cosine's, and the
# last one is above any cosine there is, which must silence everything.
