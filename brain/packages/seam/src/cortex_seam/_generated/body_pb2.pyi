...
class SessionSummary(_message.Message):
    __slots__ = ("session_id", "title", "preview", "last_activity_unix_ms", "hoisted")
    SESSION_ID_FIELD_NUMBER: _ClassVar[int]
    TITLE_FIELD_NUMBER: _ClassVar[int]
    PREVIEW_FIELD_NUMBER: _ClassVar[int]
    LAST_ACTIVITY_UNIX_MS_FIELD_NUMBER: _ClassVar[int]
    HOISTED_FIELD_NUMBER: _ClassVar[int]
    session_id: str
    title: str
    preview: str
    last_activity_unix_ms: int
    hoisted: bool
    def __init__(self, session_id: _Optional[str] = ..., title: _Optional[str] = ..., preview: _Optional[str] = ..., last_activity_unix_ms: _Optional[int] = ..., hoisted: _Optional[bool] = ...) -> None: ...
...
class SetSessionHoistedRequest(_message.Message):
    __slots__ = ("session_id", "hoisted")
    SESSION_ID_FIELD_NUMBER: _ClassVar[int]
    HOISTED_FIELD_NUMBER: _ClassVar[int]
    session_id: str
    hoisted: bool
    def __init__(self, session_id: _Optional[str] = ..., hoisted: _Optional[bool] = ...) -> None: ...

class SetSessionHoistedReply(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...
...
class CaptureScreenReply(_message.Message):
    __slots__ = ("image", "resolved_target", "target_width", "target_height")
    ...
    target_width: int
    target_height: int
    def __init__(self, image: _Optional[_Union[ImageBlob, _Mapping]] = ..., resolved_target: _Optional[_Union[CaptureTarget, str]] = ..., target_width: _Optional[int] = ..., target_height: _Optional[int] = ...) -> None: ...
