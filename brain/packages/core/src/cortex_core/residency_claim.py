...
lock with nothing awaited between them, and the loser is refused while the machine is untouched,
which is what lets it be told the honest thing (a handoff is running) rather than a swap failure.
"""
