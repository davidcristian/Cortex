...
DEFAULT_TIER_RECHECK_INTERVAL_S = 30.0
...
class TierRechecker:
    ...
    def __init__(
        ...
        *,
        interval_s: float = DEFAULT_TIER_RECHECK_INTERVAL_S,
    ) -> None:
    ...
    def start(self) -> None:
        ...
        if self._task is None:
            self._task = asyncio.create_task(self.run(), name="residency-tier-recheck")
