//! Live seam check in the Rust `integration` suite (AGENTS.md gate 3, ADR-0002 decision 8's Rust
//! counterpart): `#[ignore]`d so it never runs in CI or counts toward coverage.
