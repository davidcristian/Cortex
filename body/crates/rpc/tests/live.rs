//! Live seam checks in the Rust `integration` suite (AGENTS.md gate 3, ADR-0003 decision 3; the
//! Rust counterpart of ADR-0002 decision 8's `integration` marker): `#[ignore]`d so they never run
