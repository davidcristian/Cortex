...
describe("Panel", () => {
  it("shows the title, marks itself open, and wires the header buttons", () => {
    const onDismiss = vi.fn();
    const onNewChat = vi.fn();
    render(
      <Panel state={state()} open={true} onSubmit={vi.fn()} onDismiss={onDismiss} onNewChat={onNewChat} />,
    );
  ...
  it("is not open when closed and renders its messages", () => {
    render(
      <Panel
