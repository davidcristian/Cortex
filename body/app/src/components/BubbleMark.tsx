...
// Draws the Cortex mark, a soap bubble. Which bubble is drawn is data in `mark/marks.ts`; this
// renders any of them. `idPrefix` keeps the SVG gradient and clip ids unique per mount, because
// those ids are document-global and two marks can be on screen at once.
