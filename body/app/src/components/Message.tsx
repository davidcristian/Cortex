...
// slim inline chips above it, between bubbles (design/overlay-ux.md §3), gone on completion.
// Errors render as an alert. Color lives only in the working/error states.
