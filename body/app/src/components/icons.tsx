...
// The header's outline icon set: 1.7px round-cap strokes on a 24 grid, `currentColor`, hollow.
// Each icon is small and static, so the buttons stay presentational.
...
/** An action that needs the user's approval: a hollow shield. */
 ...
 *  confused with the dismiss chevron or the check. */
 ...
 *  chat rather than covering it, so leaving it is a return rather than a close. */
 ...
 *  anything, and a recurring series fires again afterwards, so it must not read as a delete. */
