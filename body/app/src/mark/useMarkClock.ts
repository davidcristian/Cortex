...
// The mark's clock: elapsed seconds since it mounted, advanced once per animation frame. The
// bubble's whole motion is a function of this number, so reduced motion only has to freeze it.
