...
// The bubble's whole motion is a function of this number, so freezing it (reduced motion) is the
// entire still-mark story: no frames are scheduled and the shape holds the pose below.
